                        ...
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-md-2 col-form-label text-right">Mô tả ngắn</label>
                                        <div class="col-md-10">
                                            <textarea class="form-control" name="description">{!!old('description')!!}</textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-md-2  control-label text-right text-semibold" for="images">Ảnh mô tả:</label>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-md-2  control-label text-right text-semibold" for="images">Ảnh chi tiết:</label>
                                        <div class="col-lg-10 div-image">
                                            <div class="file-input file-input-ajax-new">
                                                <div class="file-preview ">
                                                    <div class=" file-drop-zone">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-md-2  control-label text-right text-semibold" for="images">Ảnh feedback:</label>
                                        <div class="col-lg-10 div-image">
                                            <div class="file-input file-input-ajax-new">
                                                <div class="file-preview ">
                                                    <div class=" file-drop-zone">
                                            ...
                                            <input type="hidden" name="feedback" class="image_data">
                                            <span class="help-block">Chỉ cho phép các file ảnh có đuôi <code>jpg</code>, <code>gif</code> và <code>png</code>. File có dung lượng tối đa 20M.</span>
                                        </div>
                                    </div>
                                </fieldset>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-5">
                                        <input type="text" name="ordering" class="form-control touchspin text-center" value="{{++$ordering}}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <div class="form-check col-md-6 form-check-right">
                                        <label class="form-check-label float-right">
                                            Trả góp
                                            <input type="checkbox" class="form-check-input-styled" name="is_tragop" data-fouc="">
                                        </label>
                                    </div>
                                </div>
