    ...
    <div class="card">
        ...
        <div class="card-body row">
            ...
            <div class="col-lg-8 col-md-8 col-sm-8">
                    <div class="body">
                        <form action="{!!route('admin.role.update',$record->id)!!}" method="POST" enctype="multipart/form-data">
                            <input type="hidden" name="_token" value="{!! csrf_token() !!}" />
                            <div class="form-group row">
                                <label class="col-md-1 text-right">Vai trò</label>
                                <input type="text" class="form-control col-md-9" name="name" value="{{$record->name}}">
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="form-check col-md-3 form-check-left">
                                    <label class="form-check-label float-left">
                                       <b>{{trans('route.admin.'.$value.'.index')}}</b>
                                        <input type="checkbox" class="form-check-input-styled custom-control-input" name="route[]" value="{{$value}}" data-fouc @if(in_array($value,$route))checked @endif>
                                    </label>
                                </div>
