  <!-- Footer Start -->
    ...
    background-size: cover;">
        <div class="footer-container footer-destop" style="background: rgba(16, 16, 16, 0.5);">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-lg-3 ec-footer-contact">
                            <div class="ec-footer-widget">
                                <div class="ec-footer-logo"><a href="#"><img style="width: 60%;" src="assets/images/favicon/vdiamond.png"
                                            alt=""><img class="dark-footer-logo" src="assets/images/favicon/vdiamond.png"
                        ...
                        <div  class="col-sm-12 col-lg-3 ec-footer-news">
                          <div style="background: rgba(232, 159, 113, 0.65); backdrop-filter: blur(4px); height: 110%;  position: relative; bottom:50px;">
                            <div style="padding-top: 50px; padding-left: 20px; padding-right: 20px;" class="ec-footer-widget">
            ...
            <div class="footer-bottom" style="border: none; background: rgba(16, 16, 16, 0.78);">
              <div  class="container">
                  
                  <div class="row">
                    <div class="col-md-11" style="font-family: Open Sans;
                                                  font-style: normal;
                                                  font-weight: normal;
                                                  font-size: 14px;
                                                  line-height: 39px;
                                                  color: #FFFFFF;">
                      Công Ty Cổ Phần Nội Thất Kim Cương Việt - Giấy phép kinh doanh số: 01160797 do Sở Kế hoạch và Đầu tư Thành phố Hải Phòng cấp ngày 16/07/2021 
                    </div>
                    <div class="col-md-1">
                       <img src="assets/images/icons/bo-cong-thuong.png" alt="">
                    </div>
                  </div>
              </div>
            </div> 
