        ...
        <div  id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
          ...
          <div style="" class="carousel-inner">
            <div class="carousel-item active">
              <img class="d-block w-100 responsive" src="assets/images/images/image1.png" alt="First slide">
              <div class="carousel-content">
                <h1 class="text-upper slide-text-1">sản phẩm mới</h1>
                <h2 class="text-upper slide-text-2">bộ ghế phòng khách linh hoạt</h2>
                <p class="text-upper slide-text-3">Sản phẩm mang thiết kế tinh tế, tạo đẳng cấp cho không gian phòng Khách của bạn.</p>
                <button style=" filter: drop-shadow(0px 3px 12px rgba(255, 111, 0, 0.69)); background-color: #FF6F00; color: white; border-radius: 0px; width: 161px; height:  40px;" class="btn">Mua ngay</button>
              </div>
            </div>

            <div class="carousel-item">
              <img class="d-block w-100 responsive" src="assets/images/images/image1.png" alt="Second slide">

            </div>
            <div class="carousel-item">
              <img class="d-block w-100 responsive" src="assets/images/images/image1.png" alt="Third slide">
            </div>
          </div>
                ...
                <div class="col">
                    <div class="tab-content">
                                    ...
                                    <div class="ec-product-inner border-product">
                                        ...
                                        <div class="ec-pro-content">
                                            ...
                                            <span class="ec-price" style="justify-content: center !important;">
                                                ...
                                                <span style="" class="new-price">45.000.000đ</span>
                                            </span>
                        ...
                        <style type="text/css">
							...
							.carousel-control-next-icon-1, .carousel-control-prev-icon-1 {
							...
							.carousel-control-next-icon-2, .carousel-control-prev-icon-2 {
								background-color: #E89F71;
								border-radius: 100%;
							    width: 50px;
							    height: 50px;
                        ...
                        <div class="tab-pane fade" id="tab-pro-for-men">
                           ...
                           <!--    <div id="carouselExampleIndicators1" class="carousel slide" data-ride="carousel">
								  <div class="carousel-inner">
								    <div class="carousel-item active">
								      <img class="d-block w-100" src="assets/images/images/image1.png" alt="First slide">
								    </div>
								    <div class="carousel-item">
								      <img class="d-block w-100" src="assets/images/images/image1.png" alt="Second slide">
								    </div>
								    <div class="carousel-item">
								      <img class="d-block w-100" src="assets/images/images/image1.png" alt="Third slide">
								    </div>
								  </div>
								  <div  class="row">
                                      <div class="col-md-4">
	                                    <ol style="justify-content: flex-start; margin-left: 7px; top: 30px;" class="carousel-indicators-ol-1 carousel-indicators-1 carousel-indicators">
									...
									<div style="text-align: center;" class="col-md-4">
										...
										<a class="carousel-control-prev carousel-control-prev-1" href="#carouselExampleIndicators1" role="button" data-slide="prev">
										    <span class="carousel-control-prev-icon carousel-control-prev-icon-1" aria-hidden="true"></span>
										    <span class="sr-only">Previous</span>
									    </a>

									    <a class="carousel-control-next carousel-control-next-1" href="#carouselExampleIndicators1" role="button" data-slide="next">
										    <span class="carousel-control-next-icon carousel-control-next-icon-1" aria-hidden="true"></span>
										    <span class="sr-only">Next</span>
									    </a>
									   
									</div>
									<div class="col-md-4">
										<a style=" color:#FF6F00; font-weight: 700; font-size: 15px; float: right; margin-top: 34px;" href="#">XEM THÊM <img style=" margin-bottom:5px;width: 23px; height: 22px;" src="assets/images/icons/arrow-right.png"></a>
									</div>
          ...
          <div class="owl-carousel owl-theme" id="luxury-carousel">
            <div class="item news-home">
                <div style="" class="luxury-content row">
                     ...
                     <h3 class="luxury-head text-upper" >Bộ ghế sofa hiện đại</h3>
                     <p class="luxury-text">Sản phẩm mang thiết kế tinh tế, tạo đẳng cấp cho không gian phòng Khách của bạn.</p>
                     ...
                     <div style=" width:27%; height: 130px; background-color: rgba(212, 212, 212, 0.36); backdrop-filter: blur(31px);" class="row">
                     		<h4 class="luxury-title text-upper">sofa hiện đại phong cách</h4>
                     	 	<span class="luxury-model">Model: 123</span>
                     	 	<span class="luxury-sale">17.000.000 đ</span>
                     	 	<span class="luxury-price">25.000.000 đ</span>
                     	</div>
            ...
            <div class="item news-home">
                <div style="" class="news-content row">
                     <img class="" style=" height: 560px; object-fit: cover;" src="assets/images/product/top-product-2.png">
                </div>
            </div>
            <div class="item news-home">
        ...
        <div style="height: 1380px;" class="row">
            <div  class="best-seller-description">
    			...
    			<div id="carouselExampleIndicators2" class="carousel slide" data-ride="carousel">
					  ...
					  <div class="carousel-inner top-carousel">
					    <div class="carousel-item active">
          ...
          <div class="owl-carousel owl-theme" id="news-carousel">
            <div class="item news-home">
                <div style="background-color: white; margin-right: -10px; margin-left: -10px;" class="news-content row">
                    ...
                    <h4  style="float: left;" class="col-md-12">Sofa nỉ cao cấp thiết kế thoải mái cho người dùng</h4>
                    <p class="col-md-12">Sofa nỉ cao cấp với đa dạng màu sắc, thiết kế tinh tế và mềm mại, mang đến không gian sang trọng, đẳng cấp cho không gian nội thất. Được thiết kế bởi những thương hiệu...</p>
                </div>
            </div>
            <div class="item news-home">
                <div style="background-color: white; margin-right: -10px; margin-left: -10px;" class="news-content row">
