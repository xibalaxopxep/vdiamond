    ...
    <div class="bg-grey">
        ...
        <div class="container">
            <div class="bg-white row" style="margin: 0;">
                <div class="hz-main-contents full-width">
                            ...
                            <section class="editProfileSection ">
                                <div class="fieldGroup">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="title" name="title" value="" class="form-control  input-lg edit-profile-input" required>
                                    </div>
                                    <div class="form-group" id="groupdomain">
                                        <label class="" for="description">Mô tả</label>
                                        <textarea rows="5" class="form-control input-lg edit-profile-input hzUrlInput" id="description" name="description" required></textarea>
                                    </div>
                                    <div class="form-group">
