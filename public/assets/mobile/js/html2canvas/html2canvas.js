...
var createCounterText = function createCounterText(value, type) {
    switch (type) {
        ...
        case _listStyle.LIST_STYLE_TYPE.CJK_DECIMAL:
            return createCounterStyleFromSymbols(value, 'ã€‡ä¸€äºŒä¸‰å››äº”å…­ä¸ƒå…«ä¹', 'ã€');
        ...
        case _listStyle.LIST_STYLE_TYPE.CJK_EARTHLY_BRANCH:
            return createCounterStyleFromSymbols(value, 'å­ä¸‘å¯…å¯è¾°å·³åˆæœªç”³é…‰æˆŒäº¥', 'ã€');
        case _listStyle.LIST_STYLE_TYPE.CJK_HEAVENLY_STEM:
            return createCounterStyleFromSymbols(value, 'ç”²ä¹™ä¸™ä¸æˆŠå·±åºšè¾›å£¬ç™¸', 'ã€');
        case _listStyle.LIST_STYLE_TYPE.CJK_IDEOGRAPHIC:
        case _listStyle.LIST_STYLE_TYPE.TRAD_CHINESE_INFORMAL:
            return createCJKCounter(value, 'é›¶ä¸€äºŒä¸‰å››äº”å…­ä¸ƒå…«ä¹', CHINESE_INFORMAL_MULTIPLIERS, 'è² ', 'ã€', CJK_TEN_COEFFICIENTS | CJK_TEN_HIGH_COEFFICIENTS | CJK_HUNDRED_COEFFICIENTS);
        case _listStyle.LIST_STYLE_TYPE.TRAD_CHINESE_FORMAL:
            return createCJKCounter(value, 'é›¶å£¹è²³åƒè‚†ä¼é™¸æŸ’æŒçŽ–', CHINESE_FORMAL_MULTIPLIERS, 'è² ', 'ã€', CJK_ZEROS | CJK_TEN_COEFFICIENTS | CJK_TEN_HIGH_COEFFICIENTS | CJK_HUNDRED_COEFFICIENTS);
        case _listStyle.LIST_STYLE_TYPE.SIMP_CHINESE_INFORMAL:
            return createCJKCounter(value, 'é›¶ä¸€äºŒä¸‰å››äº”å…­ä¸ƒå…«ä¹', CHINESE_INFORMAL_MULTIPLIERS, 'è´Ÿ', 'ã€', CJK_TEN_COEFFICIENTS | CJK_TEN_HIGH_COEFFICIENTS | CJK_HUNDRED_COEFFICIENTS);
        case _listStyle.LIST_STYLE_TYPE.SIMP_CHINESE_FORMAL:
            return createCJKCounter(value, 'é›¶å£¹è´°åè‚†ä¼é™†æŸ’æŒçŽ–', CHINESE_FORMAL_MULTIPLIERS, 'è´Ÿ', 'ã€', CJK_ZEROS | CJK_TEN_COEFFICIENTS | CJK_TEN_HIGH_COEFFICIENTS | CJK_HUNDRED_COEFFICIENTS);
        case _listStyle.LIST_STYLE_TYPE.JAPANESE_INFORMAL:
            return createCJKCounter(value, 'ã€‡ä¸€äºŒä¸‰å››äº”å…­ä¸ƒå…«ä¹', 'åç™¾åƒä¸‡', JAPANESE_NEGATIVE, 'ã€', 0);
        case _listStyle.LIST_STYLE_TYPE.JAPANESE_FORMAL:
            return createCJKCounter(value, 'é›¶å£±å¼å‚å››ä¼å…­ä¸ƒå…«ä¹', 'æ‹¾ç™¾åƒä¸‡', JAPANESE_NEGATIVE, 'ã€', CJK_ZEROS | CJK_TEN_COEFFICIENTS | CJK_TEN_HIGH_COEFFICIENTS);
        case _listStyle.LIST_STYLE_TYPE.KOREAN_HANGUL_FORMAL:
            return createCJKCounter(value, 'ì˜ì¼ì´ì‚¼ì‚¬ì˜¤ìœ¡ì¹ íŒ”êµ¬', 'ì‹­ë°±ì²œë§Œ', KOREAN_NEGATIVE, ', ', CJK_ZEROS | CJK_TEN_COEFFICIENTS | CJK_TEN_HIGH_COEFFICIENTS);
        case _listStyle.LIST_STYLE_TYPE.KOREAN_HANJA_INFORMAL:
            return createCJKCounter(value, 'é›¶ä¸€äºŒä¸‰å››äº”å…­ä¸ƒå…«ä¹', 'åç™¾åƒè¬', KOREAN_NEGATIVE, ', ', 0);
        case _listStyle.LIST_STYLE_TYPE.KOREAN_HANJA_FORMAL:
            return createCJKCounter(value, 'é›¶å£¹è²³åƒå››äº”å…­ä¸ƒå…«ä¹', 'æ‹¾ç™¾åƒ', KOREAN_NEGATIVE, ', ', CJK_ZEROS | CJK_TEN_COEFFICIENTS | CJK_TEN_HIGH_COEFFICIENTS);
        ...
        case _listStyle.LIST_STYLE_TYPE.KATAKANA:
            return createCounterStyleFromSymbols(value, 'ã‚¢ã‚¤ã‚¦ã‚¨ã‚ªã‚«ã‚­ã‚¯ã‚±ã‚³ã‚µã‚·ã‚¹ã‚»ã‚½ã‚¿ãƒãƒ„ãƒ†ãƒˆãƒŠãƒ‹ãƒŒãƒãƒŽãƒãƒ’ãƒ•ãƒ˜ãƒ›ãƒžãƒŸãƒ ãƒ¡ãƒ¢ãƒ¤ãƒ¦ãƒ¨ãƒ©ãƒªãƒ«ãƒ¬ãƒ­ãƒ¯ãƒ°ãƒ±ãƒ²ãƒ³', 'ã€');
        case _listStyle.LIST_STYLE_TYPE.KATAKANA_IROHA:
            return createCounterStyleFromSymbols(value, 'ã‚¤ãƒ­ãƒãƒ‹ãƒ›ãƒ˜ãƒˆãƒãƒªãƒŒãƒ«ãƒ²ãƒ¯ã‚«ãƒ¨ã‚¿ãƒ¬ã‚½ãƒ„ãƒãƒŠãƒ©ãƒ ã‚¦ãƒ°ãƒŽã‚ªã‚¯ãƒ¤ãƒžã‚±ãƒ•ã‚³ã‚¨ãƒ†ã‚¢ã‚µã‚­ãƒ¦ãƒ¡ãƒŸã‚·ãƒ±ãƒ’ãƒ¢ã‚»ã‚¹', 'ã€');
