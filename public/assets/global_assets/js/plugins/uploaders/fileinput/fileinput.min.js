...
!function(e) {
    ...
    t = {
        ...
        isIE: function(e) {
            var t, i;
            return "Microsoft Internet Explorer" !== navigator.appName ? !1 : 10 === e ? new RegExp("msie\\s" + e,"i").test(navigator.userAgent) : (t = document.createElement("div"),
            ...
            if (e && e.length) {
                ...
                e.off(r).on(r, function() {
                    var r = e.get(0)
                      ...
                      , l = r.offsetWidth
                      , s = t.getRotation(a);
                    if (e.data("orientation", a),
                    n && i.data("orientation", a),
                    5 > a)
                        return t.setTransform(r, s),
                        void t.setTransform(n, s);
                    var d = Math.atan(l / o)
                      , c = Math.sqrt(Math.pow(o, 2) + Math.pow(l, 2))
                      , p = c ? o / Math.cos(Math.PI / 2 + d) / c : 1
                      , u = " scale(" + Math.abs(p) + ")";
                    t.setTransform(r, s + u),
                    t.setTransform(n, s + u)
                })
            }
        }
    },
    ...
    i.prototype = {
        ...
        _initTemplateDefaults: function() {
            ...
            k = "{content}\n",
            O = " {style}",
            F = '<div class="kv-preview-data file-preview-html" title="{caption}"' + O + ">{data}</div>\n",
            ...
            Z._isPdfRendered() && (R = Z.pdfRendererTemplate.replace("{renderer}", Z._encodeURI(Z.pdfRendererUrl))),
            Z.defaults = {
                layoutTemplates: {
                    main1: i,
                    main2: a,
        ...
        _zoneDragEnter: function(i) {
            ...
            void (i.originalEvent.dataTransfer.dropEffect = "none")) : void (a._raise("fileDragEnter", {
                sourceEvent: i,
                files: r.types.Files
        ...
        _zoneDrop: function(e) {
            ...
            if (e.preventDefault(),
            !a.isDisabled && !t.isEmpty(o) && a._raise("fileDragDrop", {
                sourceEvent: e,
                files: o
            }))
                if (s > 0) {
        ...
        _setZoomContent: function(i, a) {
            var r, n, o, l, s, d, c, p, u, f, m = this, v = i.attr("id"), g = m.$preview.find("#zoom-" + v), h = m.$modal, w = h.find(".btn-fullscreen"), _ = h.find(".btn-borderless"), b = h.find(".btn-toggleheader");
            ...
            f = i.data("size") || "",
            l = u + " " + f,
            h.find(".kv-zoom-title").attr("title", e("<div/>").html(l).text()).html(l),
            ...
            m._handler(b, "click", function() {
                var e, t = h.find(".modal-header"), i = h.find(".modal-body .floating-buttons"), a = t.find(".kv-zoom-actions"), r = function(e) {
                    var i = m.$modal.find(".kv-zoom-body")
                      , a = m.zoomModalHeight;
                    h.hasClass("file-zoom-fullscreen") && (a = i.outerHeight(!0),
                    e || (a -= t.outerHeight(!0))),
            ...
            m._handler(h, "keydown", function(t) {
                var i = t.which || t.keyCode
                  ...
                  , o = m.rtl ? 39 : 37
                  , l = m.rtl ? 37 : 39;
                i === o && a.length && !a.attr("disabled") && m._zoomSlideShow("prev", n),
                i === l && r.length && !r.attr("disabled") && m._zoomSlideShow("next", n)
            })
        },
        ...
        _ajaxSubmit: function(t, i, a, r, n, o) {
            var l, s, d = this;
            d._raise("filepreajax", [n, o]) && (d._uploadExtra(n, o),
            d._initAjaxSettings(),
        ...
        _previewDefault: function(i, a, r) {
            var n = this
              , o = n.$preview;
            if (n.showPreview) {
                var l, s = i ? i.name : "", d = i ? i.type : "", c = i.size || 0, p = n.slug(s), u = r === !0 && !n.isAjaxUpload, f = t.createObjectURL(i);
        ...
        _previewFile: function(e, t, i, a, r, n) {
            if (this.showPreview) {
                var o, l = this, s = t ? t.name : "", d = n.type, c = n.name, p = l._parseFileType(d, s), u = l.allowedPreviewTypes, f = l.allowedPreviewMimeTypes, m = l.$preview, v = t.size || 0, g = u && u.indexOf(p) >= 0, h = f && -1 !== f.indexOf(d), w = "text" === p || "html" === p || "image" === p ? i.target.result : r;
                if ("html" === p && l.purifyHtml && window.DOMPurify && (w = window.DOMPurify.sanitize(w)),
                g || h) {
                    o = l._generatePreviewTemplate(p, w, s, d, a, !1, v),
                    l._clearDefaultPreview(),
                    l._addToPreview(m, o);
                    var _ = m.find("#" + a + " img");
                    l._validateImageOrientation(_, t, a, c, d, v, w)
                } else
                    l._previewDefault(t, a);
                l._setThumbAttr(a, c, v),
                l._initSortable()
            }
        },
        ...
        _getExifObj: function(e) {
            ...
            return i || t._log("Error loading the piexif.js library."),
            i
        },
        _validateImageOrientation: function(e, i, a, r, n, o, l) {
            var s, d, c = this;
            return s = e.length && c.autoOrientImage ? c._getExifObj(l) : null,
            (d = s ? s["0th"][piexif.ImageIFD.Orientation] : null) ? (t.setImageOrientation(e, c.$preview.find("#zoom-" + a + " img"), d),
            c._raise("fileimageoriented", {
                $img: e,
                file: i
            }),
        ...
        _validateImage: function(t, i, a, r, n, o) {
            ...
            m.one("load", function() {
                ...
                c._checkDimensions(f, "Small", m, u, i, "Width", l),
                c._checkDimensions(f, "Small", m, u, i, "Height", l),
                c.resizeImage || (c._checkDimensions(f, "Large", m, u, i, "Width", l),
                c._checkDimensions(f, "Large", m, u, i, "Height", l)),
        ...
        _initClickable: function() {
            var i, a, r = this;
            r.isClickable && (i = r.$dropZone,
            r.isAjaxUpload || (a = r.$preview.find(".file-default-preview"),
            a.length && (i = a)),
            t.addCss(i, "clickable"),
            i.attr("tabindex", -1),
            r._handler(i, "click", function(t) {
                var a = e(t.target);
                e(r.elErrorContainer + ":visible").length || a.parents(".file-preview-thumbnails").length && !a.parents(".file-default-preview").length || (r.$element.data("zoneClicked", !0).trigger("click"),
                i.blur())
            }))
        },
        ...
        _browse: function(e) {
            var t = this;
            e && e.isDefaultPrevented() || !t._raise("filebrowse") || (t.isError && !t.isAjaxUpload && t.clear(),
        ...
        readFiles: function(i) {
            ...
            a = function(x) {
                ...
                x >= f)
                    ...
                    s.removeClass("file-thumb-loading"),
                    void d.html("");
                var T, E, S, k, F, P, I, A, D, z, $, j, U = v + x, R = u + "-" + U, B = i[x], O = m.text, L = m.image, M = m.html, Z = B && B.name ? r.slug(B.name) : "", N = (B && B.size || 0) / 1e3, H = "", q = t.createObjectURL(B), W = 0, V = "", K = 0, Y = function() {
                    var e = p.setTokens({
                        index: x + 1,
                        files: f,
                        percent: 50,
                ...
                if (B) {
                    ...
                    if (Z === !1)
                        return void a(x + 1);
                    if (0 === Z.length)
                        return S = r.msgInvalidFileName.replace("{name}", t.htmlEncode(B.name, "[unknown]")),
                        void y(S, B, R, x);
                    ...
                    if (!t.isEmpty(g) && t.isArray(g)) {
                        for (E = 0; E < g.length; E += 1)
                            k = g[E],
                            A = m[k],
                            W += A && "function" == typeof A && A(B.type, B.name) ? 1 : 0;
                        if (0 === W)
                    ...
                    if (0 === W && !t.isEmpty(w) && t.isArray(w) && !t.isEmpty(H) && (F = t.compare(Z, H),
                    ...
                    0 === W))
                        ...
                        void y(S, B, R, x);
                    if (!r.showPreview)
                        return r.isAjaxUpload && r.addToStack(B),
                        setTimeout(function() {
                            a(x + 1),
                            r._updateFileDetails(f)
                        }, 100),
                    ...
                    if (!C && N > b)
                        return r.addToStack(B),
                        s.addClass("file-thumb-loading"),
                        r._previewDefault(B, R),
                        r._initFileActions(),
                        r._updateFileDetails(f),
                        void a(x + 1);
                    o.length && void 0 !== FileReader ? (D = O(B.type, Z),
                    z = M(B.type, Z),
                    $ = L(B.type, Z),
                    ...
                    l.onload = function(i) {
                        ...
                        0 === K) {
                            ...
                            c = t.isSvg(d) ? "image/svg+xml" : t.getMimeType(a, d, B.type)),
                            n = {
                                name: Z,
                                type: c
                            },
                    ...
                    ,
                    D || z ? l.readAsText(B, r.textEncoding) : $ ? l.readAsDataURL(B) : l.readAsArrayBuffer(B)) : (r._previewDefault(B, R),
                    setTimeout(function() {
                        a(x + 1),
                        r._updateFileDetails(f)
                    }, 100),
